...
public class VoicePackageActivity extends AppCompatActivity  implements RewardedVideoAdListener {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.action_like:
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(VoicePackageActivity.this);
            ...
            case  R.id.action_share:
                try {
                    sendAppItself(VoicePackageActivity.this);
                } catch (IOException e) {
                    String shareBody;
            ...
            case R.id.action_profile:
                Intent profile =new Intent(VoicePackageActivity.this,ProfileAcivity.class);
    ...
    public void onRewarded(RewardItem reward) {
        ...
        // Reward the user.
        RewardManager.AddPoint("point",reward.getAmount(),VoicePackageActivity.this);
    }
    ...
    public void onRewardedVideoAdLeftApplication() {
        ...
        RewardManager.AddPoint("point",5,VoicePackageActivity.this);
    }
