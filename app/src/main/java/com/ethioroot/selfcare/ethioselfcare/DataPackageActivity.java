...
public class DataPackageActivity extends AppCompatActivity  implements RewardedVideoAdListener {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.action_like:
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(DataPackageActivity.this);
            ...
            case  R.id.action_share:
                try {
                    sendAppItself(DataPackageActivity.this);
                } catch (IOException e) {
                    String shareBody;
            ...
            case R.id.action_profile:
                Intent profile =new Intent(DataPackageActivity.this,ProfileAcivity.class);
        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem item) {
            switch (item.getItemId()) {
                case R.id.navigation_home:
                    Intent home=new Intent(DataPackageActivity.this,MainActivity.class);
                    startActivity(home);
                    return true;
                case R.id.navigation_account_man:
                    Intent acc=new Intent(DataPackageActivity.this,AccountManager.class);
                    startActivity(acc);
                    return true;
                case R.id.navigation_extra:
                    Intent extra=new Intent(DataPackageActivity.this,giftApps.class);
                    startActivity(extra);
                    return  true;
                case R.id.navigation_gebeta:
                    Intent gebeta=new Intent(DataPackageActivity.this,GebetaActivity.class);
    ...
    public void onRewarded(RewardItem reward) {
        ...
        // Reward the user.
        RewardManager.AddPoint("point",reward.getAmount(),DataPackageActivity.this);
    }
    ...
    public void onRewardedVideoAdLeftApplication() {
        ...
        RewardManager.AddPoint("point",5,DataPackageActivity.this);
    }
