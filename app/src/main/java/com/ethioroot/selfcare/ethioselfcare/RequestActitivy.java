    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.action_like:
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(RequestActitivy.this);
            ...
            case  R.id.action_share:
                try {
                    sendAppItself(RequestActitivy.this);
                } catch (IOException e) {
                    String shareBody;
            ...
            case R.id.action_profile:
                Intent profile =new Intent(RequestActitivy.this,ProfileAcivity.class);
...
PhoneCaller.MakeCall("*806*"+txtphone.getText().toString()+"#",this);
    ...
    public void onRewarded(RewardItem reward) {
        ...
        // Reward the user.
        RewardManager.AddPoint("point",reward.getAmount(),RequestActitivy.this);
    }
    ...
    public void onRewardedVideoAdLeftApplication() {
        ...
        RewardManager.AddPoint("point",5,RequestActitivy.this);
    }
