...
public class HomeFragment extends Fragment {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        adapter = new MainMenuAdapter(getContext(), menuList);
    ...
    private void prepareAlbums() {
        ...
        a = new MainMenu("Gebeta Manager",  covers[1]);
        menuList.add(a);

        a = new MainMenu("Call Center",  covers[2]);
        menuList.add(a);

        a = new MainMenu("Facebook Lite",  covers[3]);
        menuList.add(a);


        a = new MainMenu("Gift Apps",  covers[4]);
        menuList.add(a);

        a = new MainMenu("Emergency Numbers",  covers[5]);
        menuList.add(a);
