...
public void HelpDialog(View view){
    ...
    builder.setTitle("Use Of Collecting Points");
    builder.setMessage("If You Collect 5000 Points , You will win 100 Birr Mobile Card, \n Top 3 Users at the End Of the Month Will Get 500 Birr mobile Card \n Reward Value Will Be Increase every Month.");
